...
TABLES = {
    ...
    "notifications": [
        ("id", "Primary key", "NOT NULL", "PK"),
        ("user_id", "Recipient", "NOT NULL", "FK → users.id"),
        ("type", "Notification type", "NOT NULL, indexed", ""),
        ("title", "Title", "NOT NULL", ""),
        ("message", "Message text", "NOT NULL", ""),
        ("priority", "LOW, NORMAL, HIGH, URGENT", "NOT NULL, default 'NORMAL'", ""),
        ("data", "Related entities (JSON)", "nullable", ""),
        ("action_url", "Deep link URL", "nullable", ""),
        ("is_read", "Read flag", "NOT NULL, default FALSE", ""),
        ("read_at", "Read time", "nullable", ""),
        ("is_pushed", "Push sent", "default FALSE", ""),
        ("pushed_at", "Push time", "nullable", ""),
        ("is_emailed", "Email sent", "default FALSE", ""),
        ("emailed_at", "Email time", "nullable", ""),
        ("is_sms_sent", "SMS sent", "default FALSE", ""),
        ("sms_sent_at", "SMS time", "nullable", ""),
        ("created_at", "Creation time", "NOT NULL, indexed", ""),
    ...
    "escalation_rules": [
        ("id", "Primary key", "NOT NULL", "PK"),
        ("name", "Rule name", "NOT NULL", ""),
        ("description", "Description", "nullable", ""),
        ("trigger_type", "Trigger type", "NOT NULL, indexed", ""),
        ("trigger_threshold_minutes", "Minutes before trigger", "NOT NULL", ""),
        ("severity_filter", "Severity filter (JSON)", "nullable", ""),
        ("category_filter", "Category filter (JSON)", "nullable", ""),
        ("department_type_filter", "Department type filter (JSON)", "nullable", ""),
        ("action_type", "Action type", "NOT NULL", ""),
        ("action_config", "Action config (JSON)", "nullable", ""),
        ("priority", "Rule priority (lower = higher)", "default 0", ""),
        ("is_active", "Active flag", "NOT NULL, default TRUE", ""),
        ("created_at", "Creation time", "NOT NULL", ""),
        ("updated_at", "Last update time", "NOT NULL", ""),
    ],
    "escalation_logs": [
        ("id", "Primary key", "NOT NULL", "PK"),
        ("incident_id", "Incident reference", "NOT NULL", "FK → incident_reports.id"),
        ("assignment_id", "Assignment reference", "nullable", "FK → incident_assignments.id"),
        ("rule_id", "Rule reference", "nullable", "FK → escalation_rules.id"),
        ("trigger_type", "Trigger type", "NOT NULL", ""),
        ("trigger_reason", "Human-readable reason", "nullable", ""),
        ("action_type", "Action type", "NOT NULL", ""),
        ("action_result", "Result description", "nullable", ""),
        ("action_data", "Action data (JSON)", "nullable", ""),
        ("is_successful", "Success flag", "NOT NULL, default TRUE", ""),
        ("error_message", "Error message", "nullable", ""),
        ("triggered_by_id", "User who triggered", "nullable", "FK → users.id"),
        ("triggered_at", "Trigger time", "NOT NULL, indexed", ""),
    ],
    "status_history": [
        ("id", "Primary key", "NOT NULL", "PK"),
        ("incident_id", "Incident reference", "NOT NULL", "FK → incident_reports.id"),
